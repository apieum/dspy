...
class TestCohort:
    ...
    def test_cohort_creation(self):
        ...
        assert candidate1 in cohort.candidates
        assert candidate2 in cohort.candidates
    
    def test_empty_cohort(self):
        """Test empty cohort creation."""
        cohort = Cohort()
        
        assert len(cohort.candidates) == 0
    ...
    def test_cohort_iteration(self):
        ...
        candidates_list = cohort.candidates
        assert len(candidates_list) == 2
        assert candidate1 in candidates_list
        assert candidate2 in candidates_list
    ...
    def test_cohort_add_candidates(self):
        ...
        # Add candidate
        cohort.candidates.append(candidate1)
