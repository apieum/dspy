...
from dspy.teleprompt.gepa.generation.enhanced_metrics import (
...
class TestEnhancedFeedbackFunction:
    ...
    def test_enhanced_feedback_in_reflection_context(self):
        ...
        from dspy.teleprompt.gepa.generation.prompt_mutator import ReflectivePromptMutator
        from dspy.teleprompt.gepa.generation.reflection_strategy import GEPAReflection
        from dspy.teleprompt.gepa.evaluation.feedback import FeedbackResult
