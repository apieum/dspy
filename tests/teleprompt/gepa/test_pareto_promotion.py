...
class TestParetoPromotion:
    ...
    def test_promote_applies_pareto_filtering(self):
        ...
        candidate_a.better_than = Mock(side_effect=lambda other: other == candidate_c)
        candidate_b.better_than = Mock(side_effect=lambda other: other == candidate_c)
    ...
    def test_promote_removes_strictly_dominated_candidate(self):
        ...
        candidate_a.better_than = Mock(side_effect=lambda other: other == candidate_b)
        candidate_b.better_than = Mock(return_value=False)
